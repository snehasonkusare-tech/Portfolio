    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className="relative w-full h-[230px]">
          ...
          {/* Overlay for "Tap to View" */}
          <div
            className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300 cursor-pointer"
        ...
        {/* For the Card name and description */}
        <div className="mt-5">
    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p
          ...
          className="mt-3 text-secondry text-[17px] max-w-3xl leading-[30px]"
        >
